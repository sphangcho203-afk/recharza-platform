...
export const metadata: Metadata = {
  ...
  description: "Private staff queue for order review, validation, fulfilment, and customer support.",
      ...
      <header className="border-b border-white/10 bg-[#0a0a12]">
        <div className="mx-auto flex min-h-16 max-w-7xl items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full border border-cyan-300/15 bg-cyan-300/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.14em] text-cyan-200">
              Staff
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Link href="/admin" className="hidden min-h-11 rounded-xl border border-white/10 px-3 py-3 text-xs font-bold text-slate-400 hover:bg-white/5 hover:text-white sm:block">
              Admin control
            </Link>
            <Link href="/" className="min-h-11 rounded-xl border border-white/10 px-3 py-3 text-xs font-bold text-slate-300 hover:bg-white/5">
              Customer store
            </Link>
          </div>
        </div>
        ...
        <section className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-400">
              Review assigned orders, validate account details, update fulfilment progress, and answer support tickets.
            </p>
          </div>
          <div className="rounded-xl border border-emerald-300/15 bg-emerald-300/[0.06] px-4 py-3 text-sm font-bold text-emerald-200">
            Shift active · 3 tasks assigned
          </div>
        </section>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
          <section className="overflow-hidden rounded-2xl border border-white/10 bg-[#10101a]">
            <div className="border-b border-white/8 p-5">
              <h2 className="text-lg font-black">Assigned orders</h2>
