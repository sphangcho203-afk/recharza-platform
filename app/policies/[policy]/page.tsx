  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="mx-auto grid max-w-5xl gap-8 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-[minmax(0,1fr)_17rem] lg:px-8">
        ...
        <aside className="h-fit rounded-[2rem] border border-slate-200 bg-white p-5 lg:sticky lg:top-24 shadow-xl">
          <RecharzaMark />
          ...
          <p className="mt-5 border-t border-slate-100 pt-4 text-[11px] leading-5 text-slate-400 font-medium">
