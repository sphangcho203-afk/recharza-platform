...
export default async function Home() {
  ...
  return (
    <main id="top" className="min-h-screen bg-[#07070c] text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/8">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[0.92fr_1.08fr] lg:items-center lg:px-8 lg:py-20">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 border-t border-white/8 pt-5 text-xs text-slate-500">
      ...
      <section id="games" className="mx-auto max-w-7xl scroll-mt-20 px-4 py-14 sm:px-6 lg:px-8 lg:py-18">
