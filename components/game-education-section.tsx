...
export function GameEducationSection({
  ...
  return (
    <section className="w-full bg-slate-50 border-t border-slate-200/60 pt-16 pb-24 sm:pt-20 sm:pb-32" aria-label={`About ${game.title}`}>
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-12 sm:gap-16">
          {/* Header */}
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="flex items-center gap-4 sm:gap-5">
              <div className="h-20 w-20 sm:h-24 sm:w-24 shrink-0 overflow-hidden rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-3 sm:p-4 shadow-lg">
                <StorefrontArtwork
          ...
          <div className="grid gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 space-y-10">
              <div className="prose max-w-none">
                <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <span className="h-1 w-1 rounded-full" style={{ backgroundColor: accent, color: accent }} />
                  About the game
                </h3>
              ...
              {regionNote && (
                <div className="rounded-2xl border border-amber-100 bg-amber-50 p-6 shadow-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-[11px] font-black text-amber-700 uppercase tracking-[0.15em]">Regional Policy</h4>
                      <p className="mt-1.5 text-sm leading-relaxed text-amber-900/80 font-medium">{regionNote}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="lg:col-span-7 grid gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:bg-slate-50 hover:border-slate-300">
              ...
              <div className="sm:col-span-2 rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all hover:bg-slate-50 hover:border-slate-300">
