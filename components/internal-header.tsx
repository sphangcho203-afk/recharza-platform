      ...
      <div className="flex min-h-16 w-full items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-3">
          <Link
            ...
            className="shrink-0 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400"
          >
            <RecharzaMark compact />
          </Link>
          <div className="hidden min-w-0 sm:block">
            <p className="truncate text-[10px] font-semibold uppercase tracking-[0.14em] text-violet-300">
              {workspace} workspace
            </p>
        ...
        <div className="flex items-center gap-2">
          <span className="hidden rounded-full border border-white/10 bg-white/[0.035] px-3 py-2 text-[10px] font-semibold uppercase tracking-wider text-slate-300 min-[440px]:inline-flex">
            {roleLabel(role)}
          </span>
          <Link
            href="/"
            className="min-h-11 rounded-lg bg-white px-3.5 py-3 text-xs font-semibold text-slate-950 transition hover:bg-violet-200"
          >
            Customer store
          </Link>
        </div>
