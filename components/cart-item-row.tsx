...
export function CartItemRow({
  ...
  return (
    <article
      className={`rounded-[2rem] border border-slate-200 bg-white p-4 sm:p-6 shadow-sm transition-all duration-300 hover:border-violet-300 hover:shadow-lg ${
        busy ? "opacity-60" : ""
      }`}
      aria-busy={busy}
    >
      <div className="flex gap-5">
        <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-2xl border border-slate-100 bg-slate-50 shadow-inner ring-1 ring-slate-200/50">
          <ResilientImage
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <button
                ...
                className="inline-flex min-h-11 shrink-0 items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 text-[11px] font-bold text-slate-500 transition duration-300 hover:border-rose-200 hover:bg-rose-50 hover:text-rose-600 disabled:cursor-not-allowed disabled:opacity-50 shadow-sm sm:min-h-9 sm:px-2.5"
              >
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <button
                  ...
                  className="grid min-h-11 min-w-11 place-items-center rounded-l-lg text-slate-500 transition hover:bg-white hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35 sm:min-h-9 sm:min-w-9"
                >
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 24 24"
                ...
                <button
                  ...
                  className="grid min-h-11 min-w-11 place-items-center rounded-r-lg text-slate-500 transition hover:bg-white hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-35 sm:min-h-9 sm:min-w-9"
                >
                  <svg
                    aria-hidden="true"
                    viewBox="0 0 24 24"
