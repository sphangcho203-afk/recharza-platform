...
export function OrderLookupForm() {
  ...
  return (
    <form
      onSubmit={submit}
      className="mx-auto max-w-2xl rounded-[2.5rem] border border-slate-200 bg-white p-5 shadow-xl sm:p-8"
    >
      ...
      <label className="mt-7 block text-sm font-bold text-slate-900">
        ...
        <input
          ...
          className="mt-2 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 font-mono text-base font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-violet-600 focus:bg-white focus:ring-4 focus:ring-violet-600/10 shadow-inner"
        />
      </label>
      ...
      <label className="mt-4 block text-sm font-bold text-slate-900">
        ...
        <textarea
          ...
          className="mt-2 w-full resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 font-mono text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-violet-600 focus:bg-white focus:ring-4 focus:ring-violet-600/10 shadow-inner"
        />
      </label>

      <button
        type="submit"
        className="mt-5 w-full rounded-xl bg-violet-600 px-5 py-3.5 text-sm font-bold text-white shadow-md transition-all duration-300 hover:bg-violet-700 hover:-translate-y-0.5"
      >
      ...
      <p
        aria-live="polite"
        className={`mt-4 rounded-xl border px-4 py-3 text-sm leading-6 font-bold ${
          isError
