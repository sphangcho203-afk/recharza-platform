            ...
            >
              ...
              >
                ...
                {showBadge ? (
                  <span
                    aria-hidden="true"
                    className="absolute -right-1.5 -top-1 grid min-h-[0.75rem] min-w-[0.75rem] place-items-center rounded-full bg-violet-600 px-0.5 text-[7px] font-black leading-none text-white shadow-sm"
                  >
                    {count > 99 ? "99+" : count}
                  </span>
                ) : null}
