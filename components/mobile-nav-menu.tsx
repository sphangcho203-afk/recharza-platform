...
export function MobileNavMenu() {
  ...
  const menu = open ? (
    <div className="recharza-scrim fixed inset-0 z-[9999] grid place-items-center p-4 isolate" onMouseDown={(event) => { if (event.target === event.currentTarget) closeMenu(); }}>
      <aside id="mobile-navigation" role="dialog" aria-modal="true" aria-labelledby={supportOpen ? "support-chooser-title" : "mobile-navigation-title"} className="recharza-sheet relative max-h-[90vh] w-full max-w-[340px] overflow-hidden rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
