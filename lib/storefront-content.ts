...
export const DEFAULT_STOREFRONT_CONTENT: StorefrontContent = {
  ...
  policies: {
    terms: {
      ...
      visible: true,
      body: `Last updated: August 2026\n\nWelcome to Recharza. These Terms of Service explain the rules for using our digital game top-up store, account tools, support channels, and checkout services. By using Recharza, you confirm that the information you submit is accurate, that you are authorized to use the selected game account, and that you will review your order carefully before payment.\n\nEach order may include a game, market, package, quantity, player ID, server or zone, billing details, and payment status. Digital fulfilment can begin after payment confirmation, so an order may not be reversible once the supplier has accepted or delivered it. Recharza may pause an order for identity verification, supplier review, payment reconciliation, fraud prevention, or suspected misuse. Availability and delivery timing can vary by game, market, supplier, and payment method.\n\nYou must not access another person’s account without permission, submit fraudulent payment details, interfere with the store, abuse support channels, or attempt unauthorized access to Recharza systems. If you notice an issue, contact support promptly with the order ID and the relevant details.\n\nRecharza is an independent digital top-up storefront. Game names, trademarks, and artwork belong to their respective publishers. These terms are a customer-facing draft for the jurisdictions in which Recharza operates and should be reviewed by qualified counsel before formal publication.`,
    },
    privacy: {
      title: "Privacy policy",
      visible: true,
      body: `Last updated: August 2026\n\nRecharza collects and uses information needed to operate a secure digital top-up service. Depending on your order, this can include your email address, player ID, server or zone, selected game and package, billing information, order and payment status, device or session security signals, and messages sent to support.\n\nWe use this information to verify destinations, price and fulfil orders, process payments through the applicable payment provider, prevent fraud and abuse, provide customer support, maintain account security, and keep reliable operational records. We do not need your game password to complete a top-up, and you should never send it to Recharza or to support.\n\nPayment details are handled by the relevant payment provider where available. Recharza retains operational records only for as long as reasonably needed for fulfilment, support, security, accounting, dispute handling, or legal obligations. Subject to applicable law, you may contact support to request access, correction, or deletion of personal information associated with your account.\n\nThis customer-facing policy is a draft for the jurisdictions in which Recharza operates and should be reviewed by qualified counsel before formal publication.`,
    },
    refunds: {
      title: "Refund policy",
      visible: true,
      body: `Last updated: August 2026\n\nRecharza sells digital game top-ups and related digital products. Before paying, confirm the game, market, player ID, server or zone, package, quantity, and final amount. Because fulfilment may start immediately after payment confirmation, a correctly delivered top-up may not be reversible.\n\nContact Recharza support promptly with your order ID if a payment was captured but no order was created, a package was not delivered, delivery failed, a duplicate charge occurred, or a top-up was delivered to the wrong destination because of a Recharza processing error. We review payment, order, supplier, and fulfilment records before issuing an eligible refund, correction, or replacement.\n\nRecharza may be unable to reverse an order when the player details were entered incorrectly by the customer, the supplier or publisher has accepted the top-up, or the digital product has already been delivered successfully. Payment-provider rules and applicable consumer-protection law may also apply.\n\nThis customer-facing policy is a draft for the jurisdictions in which Recharza operates and should be reviewed by qualified counsel and payment partners before formal publication.`,
    },
    cookies: {
      title: "Cookie notice",
      visible: true,
      body: `Last updated: August 2026\n\nRecharza uses essential cookies and equivalent browser storage to keep the storefront, account sessions, cart, checkout, security controls, currency preference, and order tracking working correctly. These technologies are necessary for core store functionality.\n\nOptional analytics or preference technologies will be used only where configured, disclosed, and permitted by applicable law. You can manage browser storage through your browser settings, although blocking essential storage may prevent account access, verification, checkout, or order tracking from working correctly.\n\nThis customer-facing notice is a draft for the jurisdictions in which Recharza operates and should be reviewed by qualified counsel before formal publication.`,
    },
  },
};
