...
export const adminModules: WorkspaceModule[] = [
  ...
  },
  {
    ...
    description: "Supplier sync, health, catalogue availability, and fulfilment gates.",
    state: "live",
    audiences: ["admin"],
    icon: "supplier",
  },
  ...
  },
  {
    ...
    href: "/admin#content",
    description: "Versioned homepage sections, announcements, game presentation, navigation, legal pages, and safe display flags.",
    state: "live",
    audiences: ["admin"],
    icon: "catalogue",
  },
